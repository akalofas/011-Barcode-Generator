...
const App = () => {
	...
	const generatePDF = () => {
		...
		labels
			...
			.forEach((label, index) => {
				...
				const xPos = 4.875900721 + col * (38.16653323 + 2.353883106);
				const yPos = 10.76330691 + row * (20.85390713 + 0.336353341);
				...
				if (sizeRangeArray.length === 1) {
					...
					const endPosition = xPos + 38.16653323 - 2;
					...
					if (pdf.getTextWidth(sizeRangeText) > 38.16653323 - 10) {
	...
	return (
		<div className='app'>
			...
			{totalLabels > 0 && (
				<>
					<p>Total Labels: {((sheetsNeeded - 1) * 65) + labelsOnLastSheet}</p>
